...
# 后面仅加入-combination
BASE_REMARK="1B-deepseek-moe-5expert-second-quarter-sharedEP-alpha-Tok2-molcap"
MODEL_BASE_PATH="/wanghaixin/OmniMol/_checkpoints/moe/llama-1B-deepseek-moe-5expert-second-quarter-sharedEP-alpha-Tok2/checkpoint-231396"
...
for TASK in "${TASK_LIST[@]}"; do
    ...
    /root/anaconda3/bin/python eval_engine.py \
        --model_type "$TYPE" \
        --task "$TASK" \
