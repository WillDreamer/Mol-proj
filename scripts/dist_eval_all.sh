...
# 后面仅加入-combination
BASE_REMARK="llama-1B-deepseek-moe-5expert-second-quarter-sharedEP-alpha-cos-re-epoch14"
MODEL_BASE_PATH="/wanghaixin/OmniMol/_checkpoints/moe/llama-1B-deepseek-moe-5expert-second-quarter-sharedEP-alpha-cos-re/checkpoint-269962"
