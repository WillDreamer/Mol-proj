...
deepspeed main.py \
    ...
    --pretrain_mm_mlp_adapter /root/autodl-tmp/MolMoE/_checkpoints/pretrain/llava-pub_chem-himol-tinyllama-crossattn-16query-16head-qk-norm/checkpoint-30695/mm_projector.bin \
    --num_query 16 \
    --num_heads 16 \
    --bf16 True \
