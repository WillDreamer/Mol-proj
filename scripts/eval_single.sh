...
# 后面仅加入-combination
BASE_REMARK="1B-deepseek-moe-3expert-second-quarter-sharedEP-alpha-only-IUPAC"
MODEL_BASE_PATH="/wanghaixin/OmniMol/_checkpoints/moe/llama-1B-deepseek-moe-3expert-second-quarter-sharedEP-alpha-only-IUPAC/checkpoint-60904"
